...
const UpdateProduct = () => {
  ...
  const handlePreview = async (file) => {
    ...
    if (file.url) {
      try {
        ...
        console.log(
          "error in handle preview while converting url to blob",
          err
        );
      }
    }
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      const { data } = await axios.put(
        `https://ecommerce-app-2023-0ik6.onrender.com/api/v1/product/update-product/${Id}`,
  ...
  const getSingleProduct = async () => {
    try {
      ...
      const { data } = await axios.get(
        `https://ecommerce-app-2023-0ik6.onrender.com/api/v1/product/single-product/${params.slug}`
      );
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://ecommerce-app-2023-0ik6.onrender.com/api/v1/product/delete-product/${Id}`
      );
